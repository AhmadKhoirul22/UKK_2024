  ...
  <ul class="d-flex align-items-center">
	...
	<li class="nav-item dropdown pe-3">
	  ...
	  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
		...
		<li>
		  <a class="dropdown-item d-flex align-items-center" href="<?= base_url('admin/dashboard/myprofile') ?>">
		...
		<li>
		  <a class="dropdown-item d-flex align-items-center" href="<?= base_url('admin/dashboard/mypassword') ?>">
		...
		<li>
		  <a class="dropdown-item d-flex align-items-center" onclick="return confirm('yakin logout?')"  href="<?= base_url('auth/logout') ?>">
